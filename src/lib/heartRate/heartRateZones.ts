...
/** Monochrome zone ramp — darker = higher intensity. */
export const HEART_RATE_ZONES: HeartRateZoneDefinition[] = [
  { zone: 1, label: "Erholung", shortLabel: "Z1 · Erholung", color: "#D4D4D8", minPct: 0.5, maxPct: 0.6 },
  { zone: 2, label: "Grundlage", shortLabel: "Z2 · Grundlage", color: "#A1A1AA", minPct: 0.6, maxPct: 0.7 },
  { zone: 3, label: "Aerob", shortLabel: "Z3 · Aerob", color: "#71717A", minPct: 0.7, maxPct: 0.8 },
  { zone: 4, label: "Schwelle", shortLabel: "Z4 · Schwelle", color: "#52525B", minPct: 0.8, maxPct: 0.9 },
  { zone: 5, label: "Maximal", shortLabel: "Z5 · Maximal", color: M.fg, minPct: 0.9, maxPct: 1.0 },
];
...
export function getZoneColorForBpm(bpm: number, maxHr: number | null, fallback = M.fg): string {
